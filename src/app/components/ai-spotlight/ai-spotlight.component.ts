        ...
        <div class="ai-banner glass-card">
          <div class="ai-content">
            <div class="badge-pill badge-purple mb-3">
              <i class="fa-solid fa-brain"></i> Neural Fitness Engine
            </div>

            <h2>Powered By <span class="gradient-text-purple">Intelligent AI & Offline Core</span></h2>

            <p class="ai-desc">
              GetFit doesn't just log numbers — it understands your body's progression. Our embedded AI algorithms analyze your workout fatigue, equipment availability, and nutrition goals to deliver real-time recommendations completely offline.
            </p>
